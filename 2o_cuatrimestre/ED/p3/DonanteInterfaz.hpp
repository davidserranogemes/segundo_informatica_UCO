...
namespace ed{
	/**
	@brief Clase DonanteInterfaz, esppecifica la clase Donante
		Especifica los metodos minimos de una clase Donante
	*/
	class DonanteInterfaz{
		public:
			...
			*/
			...
			/**
			@brief Metodo virtual puro que devuelve un entero que indica el numero de donaciones realizadas por el donante
				Metodo virtual puro que devuelve un tipo int.Actua de forma constante
			...
			*/
			...
			/**
			@brief Metodo virtual puro, devuelve void y aumenta en 1 las donaciones del donante
			Metodo virtual puro que permite modificar el valor de la informacion del donante, de tipo int
			*/
			virtual void DonacionesInc()=0;
